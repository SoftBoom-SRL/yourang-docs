...
> [!NOTE]
> **GPT Live beta**
> Backchannel and pause options are available only for GPT Live in beta. Use the current instructions to keep the previous behaviour; reset the preferences and save to return to that behaviour.
